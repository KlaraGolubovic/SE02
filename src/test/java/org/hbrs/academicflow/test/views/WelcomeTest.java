...
class WelcomeTest {
  ...
  public static final String CLASS_CARD = "  <vaadin-vertical-layout theme=\"padding spacing\" style=\"width:100%;align-items:center\" class=\"card\">\n";
  ...
  void testWelcomeView() {
    ...
    UserDTO studentUser = new UserMapperImpl().toDTO(
        userRepository.findUserByUsername("LauraStudent"));
    ...
    String divContent =
        "<div>\n" + " <vaadin-vertical-layout theme=\"padding spacing\" style=\"width:100%\">\n"
            ...
            + "   <h2></h2>\n"
            + "   <img alt=\"WillkommenFoto\" src=\"images/WillkommenFoto.jpg\" style=\"width:15vw\" class=\"profile-picture\">\n"
            + "   <p style=\"font-size:var(--lumo-font-size-l)\">Wilkommen auf AcadamicFlow. Unser Ziel ist es, DIE Jobbörse für Studenten zu werden. Wir haben viele spannende Stellenanzeigen von den Top - Unternehmen. Wir bieten außerdem die Möglichkeit, nach Tätigkeitsfeldern wie Informatik oder Maschinenbau zu suchen. Da ist sicher auch für dich etwas dabei. Leg jetzt los und finde deinen Traumjob!</p>\n"
            + VAADIN_HORIZONTAL_LAYOUT + VAADIN_VERTICAL_LAYOUT1
            + " <vaadin-horizontal-layout theme=\"spacing\">\n" + CLASS_CARD + STELLENANZEIGEN_LABEL
            + H_1 + stats.getAmountOfJobAds() + H1NL + VAADIN_VERTICAL_LAYOUT + CLASS_CARD
            + UNTERNEHMEN_LABEL + H_1 + stats.getAmountOfCompanies() + H1NL + VAADIN_VERTICAL_LAYOUT
            + CLASS_CARD + BEWERBUNGEN_LABEL + H_1 + stats.getAmountOfApplies() + H1NL
            + VAADIN_VERTICAL_LAYOUT + CLASS_CARD + STUDENTEN_LABEL + H_1
            + stats.getAmountOfStudents() + H1NL + VAADIN_VERTICAL_LAYOUT
